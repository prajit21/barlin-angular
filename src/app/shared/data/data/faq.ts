...
export const commanTopData: commanData[] = [
  ...
  {
    title: 'Knowledgebase',
    desc: 'A Website Designing course enables learners to use essential designing and programming tools required to do the job. The curriculum is a blend of various themes.',
    ican: 'book-open',
    class: 'col-md-6',
  },
  {
...
export const articlesAndVideosData: articlesAndVideos[] = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        icon: 'codepen',
        desc: 'Simple demos of frequently asked questions about using information resources',
        class: 'col-sm-12',
      },
    ],
  },
    ...
    data: [
      {
        ...
        icon: 'file-text',
        desc: 'Website is the process for ensuring that the all pages on the website conform.  ',
        class: 'col-sm-12',
      },
      {
        id: 5,
