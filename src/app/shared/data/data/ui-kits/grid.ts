...
export const offsetGridData = [
  { class: 'col-sm-5 col-4 offset-sm-3 offset-2', text: 'col-5 offset-sm-3' },
  { class: 'col-sm-2 col-4 offset-sm-2 offset-1', text: 'col-2 offset-sm-2' },
  { class: 'col-sm-4 col-5 offset-2', text: 'col-4 offset-sm-2' },
  { class: 'col-sm-3 col-4 offset-sm-2 offset-1', text: 'col-3 offset-sm-2' },
];
