...
export const commanList: commonListData[] = [
  {
    ...
    colClass: "col-md-6",
    subTitle:
      "Use <code> list-group </code>define the list of items and used <code> list-group-item </code>to indicate the current content.",
    data: [
      {
        name: "Logo Design",
      },
  ...
  },
  {
    ...
    colClass: "col-md-6",
    subTitle:
      "Use<code> active </code>in a<code> list-group-item</code> to indicate the current active.",
    data: [
      {
        name: "UI Kits",
  ...
  },
  {
    ...
    data: [
      {
        name: "CHART",
        icons: "icofont-chart-histogram-alt",
      },
      {
        name: "ALERTS",
        icons: "icofont-warning",
      },
      {
        name: "CART",
        icons: "icofont-cart",
