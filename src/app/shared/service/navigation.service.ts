...
export class NavigationService {
  ...
  constructor() {
    ...
    fromEvent(window, "resize")
      ...
      .subscribe((evt: Event) => {
        const window = (evt.target as Window).innerWidth;
  ...
  menuItems: Menu[] = [
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/form-controls/validation-forms",
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "/ui-kits/divider",
          title: "Divider",
          type: "link",
          badgeValue: "Trending",
          badgeType: "badge-light-warning",
        },
        {
        ...
        {
          path: "/ui-kits/placeholder",
          title: "Placeholders",
          type: "link",
          badgeValue: "New",
          badgeType: "badge-light-success",
        },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: "https://admin.pixelstrap.net/berlin/template/basic-template.html",
              title: "Basic Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/berlin/template/email-header.html",
              title: "Basic With Header",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/berlin/template/template-email.html",
              title: "Ecomerce Template",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/berlin/template/template-email-2.html",
            ...
            {
              path: "https://admin.pixelstrap.net/berlin/template/email-order-success.html",
              title: "Order Success",
              type: "extTabLink",
            },
          ],
